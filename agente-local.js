...
(function (w) {
  ...
  function statusServico(payload) { return requisicao("/api/nfe/status", { method: "POST", body: payload }, 60000); }
  function autorizarNFe(payload) { return requisicao("/api/nfe/autorizar", { method: "POST", body: payload }, 180000); }
  function cancelarNFe(payload) { return requisicao("/api/nfe/cancelar", { method: "POST", body: payload }, 180000); }
